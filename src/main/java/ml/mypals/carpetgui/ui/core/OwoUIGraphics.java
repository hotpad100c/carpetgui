...
*///?}
   ...
   *///?}
   ...
   public void blitTexture(ResourceLocation texture, int x, int y, float u, float v, int width, int height, int textureWidth, int textureHeight) {
      this.blitTexture(texture, x, y, u, v, width, height, width, height, textureWidth, textureHeight, -1);
   }

   public void blitTexture(ResourceLocation texture, int x, int y, float u, float v, int width, int height, int uWidth, int vHeight, int textureWidth, int textureHeight) {
      this.blitTexture(texture, x, y, u, v, width, height, uWidth, vHeight, textureWidth, textureHeight, -1);
   }

   public void blitTexture(ResourceLocation texture, int x, int y, float u, float v, int width, int height, int uWidth, int vHeight, int textureWidth, int textureHeight, int color) {
      //? if >=1.21.6 {
   ...
   public void drawTooltip(Font textRenderer, int x, int y, List<ClientTooltipComponent> components) {
      this.drawTooltip(textRenderer, x, y, components, (ResourceLocation)null);
   }
   ...
   //? if >=26.1 {
   /*protected void setTooltipForNextFrameInternal(Font textRenderer, List<ClientTooltipComponent> components, int x, int y, ClientTooltipPositioner positioner, @Nullable ResourceLocation texture, boolean replaceExisting) {
